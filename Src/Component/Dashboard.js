...
class Dashboard extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.navigation.addListener('focus', () => {
      MyData.sharedInstance.screenName = "DashBorad";
    });

    this.props.navigation.addListener('blur', () => {
      MyData.sharedInstance.screenName = "";
    });
  }
        ...
        <TouchableWithoutFeedback onPress={() => this.signout()}>
          <View style={{ width: 50, height: 65 }}>
            <Image
              ...
              tintColor='white'
              style={{
                width: 35, height: 39, marginTop: 5, marginRight: 4, transform: [{ rotate: '90deg' }]
              }}
  ...
  getNormalHeader() {
    return (
      <Text style={{
        color: 'white', fontFamily: 'Cochin', fontWeight: 'bold', fontSize: 28, marginLeft: 20, textAlign: 'center', width: '100%', textShadowColor: BlueColor,
  ...
  getsubNormalHeader() {
    return (
      <Text style={{
        color: 'white', fontFamily: 'Cochin', fontWeight: 'bold', fontSize: 14, marginLeft: 10, textAlign: 'center', width: '100%', textShadowColor: BlueColor,
        textShadowOffset: { width: 2, height: 2 },
        textShadowRadius: 10
      }}>Integrated System For Monitoring of PCPNDT ACT</Text>
