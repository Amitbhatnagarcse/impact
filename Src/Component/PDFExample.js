...
export default class PDFExample extends React.Component {
  ...
  async  onSubmit(){
    ...
    componentDidMount()
    {
      ...
      //const{ id_pdf ,back_id  } = this.props.route.params;
      
        //backbuttonnav = back_id
        backbuttonnav = 'Dashboard'
        //this.getpdf(id_pdf);
        this.getpdf('20987028');
        ...
        _headerBar = () => {
            return (
              <View style={styles.headerView}>
                  ...
                  <TouchableOpacity onPress={() => this.props.navigation.navigate(backbuttonnav)}>
                    <Image
